...
COPY public."Award" (id, name, cost, images) FROM stdin;
\.
...
COPY public."AwardToken" (id, "awardId", "studentId") FROM stdin;
\.
...
COPY public."StudentDetails" (id, age, scans, points, course, university, companies_ids, "userId") FROM stdin;
\.
...
--
-- Name: AwardToken AwardToken_awardId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."AwardToken"
    ADD CONSTRAINT "AwardToken_awardId_fkey" FOREIGN KEY ("awardId") REFERENCES public."Award"(id) ON UPDATE CASCADE ON DELETE RESTRICT;
