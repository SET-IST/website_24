...
--
-- Name: ActivityEnrollment_studentId_activityId_key; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX "ActivityEnrollment_studentId_activityId_key" ON public."ActivityEnrollment" USING btree ("studentId", "activityId");
